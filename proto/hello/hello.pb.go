...
func (x *HelloResponse) GetPageviews() int64 {
	if x != nil {
		return x.Pageviews
	}
	return 0
...
func (x *HelloResponse) GetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
const file_proto_hello_hello_proto_rawDesc = "" +
	"\n" +
	"\x17proto/hello/hello.proto\x12\x05hello\x1a\x1fgoogle/protobuf/timestamp.proto\"w\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1c\n" +
	"\tpageviews\x18\x02 \x01(\x03R\tpageviews\x12.\n" +
	"\x04time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x04timeB#Z!GoBlue/internal/proto/hello;hellob\x06proto3"
...
var file_proto_hello_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	1, // 0: hello.HelloResponse.time:type_name -> google.protobuf.Timestamp
